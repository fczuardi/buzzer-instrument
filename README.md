...
tracks held notes with last-note priority. Button A simulates a C4 note while
pressed, Button B toggles `sq32`/`saw32`, and the active note is rendered
through M5Unified's `M5.Speaker` API.
